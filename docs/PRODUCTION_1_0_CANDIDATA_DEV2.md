...
2. Ejecutar E2E de rutas/scopes/ACK v3 sobre Edge limpio: descarga TLS, aplicación, reintento, falla parcial, reinicio, offline y confirmación Central ↔ Edge con PostgreSQL. Para un Edge que ya aplicó catálogo v2, agregar y probar migración de la cadena/versiones antes de actualizarlo: Central inicia v3 en versión 1 y el modelo Edge actual aún exige versiones únicas por sucursal. Mantener v2/legado como rollback hasta el corte.
