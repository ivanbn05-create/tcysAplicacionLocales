...
2. Ejecutar E2E completo de rutas/scopes/ACK v3 con PostgreSQL, primero sobre Edge limpio y después con historial v2: descarga TLS, aplicación, reintento, falla parcial, reinicio, offline y confirmación. La migración local 0010 ya permite v2/2→v3/1 sin borrar publicaciones ni ACK; falta comprobar la transición cruzada con Central y reconciliar UUID maestros reales de Arboledas. Mantener v2/legado como rollback hasta el corte.
