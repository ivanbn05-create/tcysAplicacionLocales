...
- **Motor en ejecución al caer:** se detiene el servicio, se pone inicio manual y se deshabilitan tareas administradas. El journal y ambos árboles permanecen. Puede haber una migración parcial o nuevas ventas; se requiere conciliación asistida del SQLite/outbox. No hay rollback automático.
