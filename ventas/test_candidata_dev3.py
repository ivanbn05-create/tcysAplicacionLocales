...
class CandidataDev3BackendTests(TestCase):
    ...
    def test_tabletas_declara_fullscreen_y_usa_keypad_en_pagina_con_objetivos_tactiles(self):
        ...
        self.assertNotIn('data-tecla-pin-tableta="confirmar"', app_js)
        self.assertIn("if (estado.claveTableta.length === 4)", contrato_pin)
        self.assertIn("resolverClavePos(estado.claveTableta)", contrato_pin)
